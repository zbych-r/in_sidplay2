...
#define RESID_BRANCH_HINTS 1 //@RESID_BRANCH_HINTS@

// Compiler specifics.
#define HAVE_BUILTIN_EXPECT 0 //@HAVE_BUILTIN_EXPECT@
...
#else
const char* residfp_version_string = "2.15";
#endif
}

// Inlining on/off.
#define RESID_INLINING 0	//@RESID_INLINING@
